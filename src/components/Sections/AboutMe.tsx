...
export default function AboutMe() {
  return (
    <div css={styles} className="container" id="about-me">
      <h3>About me</h3>
      <p>
        I'm graduated in Computer Science, and I have more than 7 years of experience in web/mobile development plus acquired skills in Marketing and Product Ownership.
